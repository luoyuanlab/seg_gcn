...
flags.DEFINE_integer('embedding_dim_1', 300, 'Number of LSTM node.')
flags.DEFINE_integer('hidden_dim_f', 150, 'Number of LSTM node foward.')
flags.DEFINE_integer('hidden_dim_b', 150, 'Number of LSTM node backward.')
...
# flags.DEFINE_float('weight_decay_1', 0, 'Weight for L2 loss on Fourier matrix')
...
features = np.concatenate([np.load('/home/yld8809/pp_features_padded_train.npy'),np.load('/home/yld8809/pp_features_padded_test.npy')])


adj = np.concatenate([np.load('/home/yld8809/pp_adj_padded_train.npy'),np.load('/home/yld8809/pp_adj_padded_test.npy')])


sentence_length = np.concatenate([np.load('/home/yld8809/sentence_length_tuple_train_pp.npy'),np.load('/home/yld8809/sentence_length_tuple_test_pp.npy')])
