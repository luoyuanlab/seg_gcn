...
print(sklearn.metrics.precision_score(y_test_arg, outs_test_out_arg, average = 'binary'))
print(sklearn.metrics.recall_score(y_test_arg, outs_test_out_arg, average = 'binary'))
print(sklearn.metrics.f1_score(y_test_arg, outs_test_out_arg, average = 'binary'))

cm_pp = sklearn.metrics.confusion_matrix(y_test_arg, outs_test_out_arg)
np.save("/home/yld8809/cm_pp", cm_pp)