...
flags.DEFINE_float('weight_decay', 2e-1, 'Weight for L2 loss on Fourier matrix 1.')
...
for epoch in range(0,label.shape[0]):
    ...
    adj_neightborhood.setdiag(50,0)
#    adj_neightborhood = sp.eye(adj_underlying.shape[0])
...
np.save("/home/yld8809/cm_tp_gcn_300", cm)
np.save("/home/yld8809/cost_val_f1_tp_gcn_300",cost_val_f1)
np.save("/home/yld8809/cost_val_loss_tp_gcn_300",cost_val_loss)
np.save("/home/yld8809/cost_test_f1_tp_gcn_300",test_f1)
np.save("/home/yld8809/cost_test_loss_tp_gcn_300",test_loss)