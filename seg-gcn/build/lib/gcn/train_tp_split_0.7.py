...
rand_ind = np.hstack((true_index,noise_index[0:int(true_index.shape[0]*0.5)]))
...
np.save("/home/yld8809/cm_tp_gcn_0.5", cm)
np.save("/home/yld8809/cost_val_f1_tp_gcn_0.5",cost_val_f1)
np.save("/home/yld8809/cost_val_loss_tp_gcn_0.5",cost_val_loss)
np.save("/home/yld8809/test_f1_tp_gcn_0.5",test_f1)
np.save("/home/yld8809/test_loss_tp_gcn_0.5",test_loss)