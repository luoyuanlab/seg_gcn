...
# Load data
adj1 = np.load('/home/yld8809/dep_mat_tp_all_train.npy')
adj1 = adj1.item()
adj2 = np.load('/home/yld8809/dep_mat_tp_all_test.npy')
adj2 = adj2.item()
...
cm_tp = sklearn.metrics.confusion_matrix(y_test_arg, outs_test_out_arg)
np.save("/home/yld8809/cm_tp", cm_tp)
