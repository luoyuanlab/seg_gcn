...
flags.DEFINE_float('weight_decay', 0, 'Weight for L2 loss on F coefficients.')
...
label1_info = label1_info[idx_label1,:]
...
label2_info = label2_info[idx_label2,:]
...
label1_info = label1_info[train_ind_valid]
label2 = label2[test_ind_valid]
label2_info = label2_info[test_ind_valid]
